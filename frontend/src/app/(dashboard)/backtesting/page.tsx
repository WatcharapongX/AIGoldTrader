  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-8">
        <h2 className="text-xl font-semibold text-gray-200 mb-4">Strategy Testing</h2>
        <p className="text-gray-400">
          Strategy backtesting with historical data and walk-forward analysis tools will go here.
        </p>
      </div>
    </div>
  );
