  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-8">
        <h2 className="text-xl font-semibold text-gray-200 mb-4">Predictions</h2>
        <p className="text-gray-400">
          AI-generated trading signals with confidence scores and evidence will be displayed here.
        </p>
      </div>
    </div>
  );
