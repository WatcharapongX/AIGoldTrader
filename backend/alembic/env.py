"""Alembic environment — target metadata จาก app.models ทั้งหมด (TASK-014)."""
...
# URL จริงจาก env (ไม่ใช้ค่าใน alembic.ini ยกเว้น offline ที่ไม่ได้ override)
...
def run_migrations_offline() -> None:
    """Offline mode — generate SQL โดยไม่เชื่อมต่อ DB (ใช้ verify migration ได้)."""
